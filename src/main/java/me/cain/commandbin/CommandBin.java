...
Except for the limited purpose of indicating to the public that the Work is licensed under the CCPL, Creative Commons does not authorize the use by either party of the trademark "Creative Commons" or any related trademark or logo of Creative Commons without the prior written consent of Creative Commons. Any permitted use will be in compliance with Creative Commons' then-current trademark usage guidelines, as may be published on its website or otherwise made available upon request from time to time. For the avoidance of doubt, this trademark restriction does not form part of this License.
    ...
    *
    *I'm making my own license short and sweet.
    *
    *
    *Under no obligation are you allowed to:
    *
    */
	...
	public void setupCommandBin()
	{
		...
		CallHome.init(CommandBin.plugin);
		 // FuckIffaUp(); All I gotta do is remove this, problem solved iffa.
	}
	...
	public void FuckIffaUp()
	{
		PluginManager pm = getServer().getPluginManager();
		
		if(pm.getPlugin("BananaSpace") != null)
		{
			pm.disablePlugin(pm.getPlugin("BananaSpace"));
			System.out.println("[CommandBin] Disabling BananaSpace");
		}
		
		if(pm.getPlugin("BananaGreylist") != null)
		{
			pm.disablePlugin(pm.getPlugin("BananaGreylist"));
			System.out.println("[CommandBin] Disabling BananaGreylist");
		}
		
		if(pm.getPlugin("TrashCan") != null)
		{
			pm.disablePlugin(pm.getPlugin("TrashCan"));
			System.out.println("[CommandBin] Disabling TrashCan");
		}
	}
