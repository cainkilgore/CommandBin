...
public class EventRegistration
{
	...
	public static void setup()
	{
		...
		Bukkit.getServer().getPluginManager().registerEvent(Type.ENDERMAN_PICKUP, new EListener(), Priority.Normal, CommandBin.plugin);
		Bukkit.getServer().getPluginManager().registerEvent(Type.ENDERMAN_PLACE, new EListener(), Priority.Normal, CommandBin.plugin);
